...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $to = "editor@iiardjournals.org";
    $subject = "Application for Reviewer";
...
$message .= "--{$boundary}--";
	...
	// Success message
        ...
        $userMessage = 'Dear ' . $fname . ',<br><br>';
        $userMessage .= 'Thank you for submitting your application to IIARD Journal. ';
        $userMessage .= 'We have received your information, and our team will review it. ';
        $userMessage .= 'You can expect a response within 24 hours.<br><br>';
        $userMessage .= 'Best regards,<br>';
        $userMessage .= 'IIARD Journal Team';

        $userHeaders = "From: editor@iiardjournals.org\r\n";
        $userHeaders .= "Reply-To: editor@iiardjournals.org\r\n";
	...
	<div class="codes">
		<div class="container">
		  ...
		  <div class="row wow fadeInDown animated" data-wow-delay=".5s"><!-- /.col-lg-6 --><!-- /.col-lg-6 -->
            ...
            <p style="text-align:justify; margin: 10px;">Please fill out the form below. </p>
